...
_DIALOG_ANALYSIS_SYSTEM = (
    ...
    "Твоя задача: проанализировать запись звонка с точки зрения ЗВОНЯЩЕГО — "
    "насколько он смог получить максимум нужной информации от собеседника. "
    "Различай звонящего (тот, кто инициировал звонок) и собеседника (тот, кому звонят). "
    "Если имена неизвестны — называй их «Звонящий» и «Собеседник».\n\n"
    "Дай отчёт строго в этом формате:\n\n"
    "📋 *ИТОГ ЗВОНКА* — 2-3 предложения: зачем звонили, чем закончилось\n\n"
    "🎯 *КАКИЕ ДАННЫЕ ХОТЕЛ ПОЛУЧИТЬ ЗВОНЯЩИЙ* — перечисли конкретно, что он пытался узнать\n\n"
    "✅ *ЧТО РЕАЛЬНО ПОЛУЧИЛ* — какие факты, ответы, данные удалось вытащить (с цитатами)\n\n"
    "❌ *ЧТО НЕ ПОЛУЧИЛ И ПОЧЕМУ* — какие данные звонящий не добыл, и что этому помешало\n\n"
    ...
    "👑 *ГДЕ ЗВОНЯЩИЙ ТЕРЯЛ КОНТРОЛЬ* — моменты когда инициатива уходила к собеседнику, "
    "звонящий оправдывался, соглашался невыгодно или замолкал\n\n"
    "💬 *ФРАЗЫ КОТОРЫЕ ПОМОГАЛИ* — 2-3 цитаты звонящего, после которых собеседник раскрывался или давал данные\n\n"
    "🚫 *ФРАЗЫ КОТОРЫЕ МЕШАЛИ* — 2-3 цитаты звонящего, которые закрывали собеседника или уводили разговор не туда\n\n"
    ...
    "🏆 *ВЕРДИКТ* — одним абзацем: главная ошибка звонящего и один конкретный совет для следующего звонка\n\n"
